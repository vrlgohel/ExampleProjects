...
@LocalBinding(jndiBinding="redhat/RestAddBean/local")
@Remote(RestAddRemote.class)
@RemoteBinding(jndiBinding="redhat/RestAddBean/remote")
public class RestAddBean implements RestAddLocal, RestAddRemote {
    @EJB(mappedName = "redhat/AddOneBean/local")
